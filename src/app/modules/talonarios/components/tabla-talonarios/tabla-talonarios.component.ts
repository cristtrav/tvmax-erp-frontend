...
@Component({
  selector: 'app-tabla-talonarios',
  templateUrl: './tabla-talonarios.component.html',
  styleUrls: ['./tabla-talonarios.component.scss']
})
export class TablaTalonariosComponent {

  @Input()
  colNroTimbradoVisible: boolean = true;

  @Input()
  colFechaInicioVisible: boolean = true;

  @Input()
  colFechaVencimientoVisible: boolean = true;

  @Input()
  colTipoVisible: boolean = true;
  ...
  getHttpParams(): HttpParams {
    ...
    if(this.nroTimbrado != null) params = params.append('nrotimbrado', this.nroTimbrado); 
    return params;
  }
